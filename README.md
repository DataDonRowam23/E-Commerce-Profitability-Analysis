...
> An e-commerce project to identify which product categories and sales channels are truly profitable after all costs, which marketing platforms are delivering the best return on ad spend, and whether the return rate is eating into margins.
...
**Don Rowam**
 Data/Business Analyst | SQL · Excel · Power BI · Python

| Platform | Link |
|----------|------|
| Email | donrowam23@gmail.com |
| LinkedIn | roniance wanyonyi(don rowam) |
| GitHub | (datadonrowam23) |
